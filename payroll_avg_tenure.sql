...
SELECT      
    ...
    t.title AS title,   #Selecting job titles
		ROUND(AVG(CASE		#Using the case statement to get the average tenure, rounded to a whole number
		...
		END), 0) AS avg_tenure									    #I used 2002 since thats the latest year of to_date and matches closely to the time period of the database.
